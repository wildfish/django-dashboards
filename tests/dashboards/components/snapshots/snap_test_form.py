...
snapshots[
    "test_form_component__renders_value[get-False] 1"
] = """
...
snapshots[
    "test_form_component__renders_value[get-True] 1"
] = """
...
snapshots[
    "test_form_component__renders_value[post-False] 1"
] = """
    ...
    <div id="component-test-inner" class="dashboard-component-inner fade-in">
        <form hx-post="/app1/testdashboard/test-form/?key=test" hx-trigger="change" hx-swap="outerHTML" hx-target="#component-test-inner">
  <p>
    <label for="id_number">Number:</label>
    <select name="number" id="id_number">
  <option value="one">one</option>
...
snapshots[
    "test_form_component__renders_value[post-True] 1"
] = """
