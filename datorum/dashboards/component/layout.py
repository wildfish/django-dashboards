...
class Card(HTMLComponentLayout):
    template_name: str = "datorum/dashboards/layout/components/card.html"
...
class Div(HTMLComponentLayout):
    template_name: str = "datorum/dashboards/layout/components/div.html"
    width: Optional[int] = 12


class TabContainer(HTMLComponentLayout):
    template_name: str = "datorum/dashboards/layout/components/tabs/container.html"
...
class Tab(HTMLComponentLayout):
    tab_label: str = ""
    template_name: str = "datorum/dashboards/layout/components/tabs/content.html"
    ...
    def render_tab(self):
        return mark_safe(
            render_to_string(
                "datorum/dashboards/layout/components/tabs/tab.html",
                {
