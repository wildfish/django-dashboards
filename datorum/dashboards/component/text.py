...
class Text(Component):
    template: str = "datorum/dashboards/components/text/text.html"
...
class Stat(Component):
    template: str = "datorum/dashboards/components/text/stat.html"
...
@dataclass
class CTA(Component):
    template: str = "datorum/dashboards/components/cta.html"
...
class Progress(Component):
    template: str = "datorum/dashboards/components/text/progress.html"
...
class Timeline(Component):
    template: str = "datorum/dashboards/components/text/timeline.html"
