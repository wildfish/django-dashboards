...
from datorum.dashboards.component import Component
from datorum.dashboards.component.layout import Card, ComponentLayout
from datorum.dashboards.config import Config
from datorum.dashboards.log import logger
from datorum.dashboards.permissions import BasePermission
...
class Dashboard(metaclass=DashboardType):
    ...
    def get_dashboard_permissions(cls):
        ...
        if cls.Meta.permission_classes:
            ...
            permissions_classes = []
            for permission_class_path in Config().DATORUM_DEFAULT_PERMISSION_CLASSES:
                try:
    ...
    def get_absolute_url(cls):
        return reverse(f"datorum.dashboards:dashboards:{cls.get_slug()}")
...
class ModelDashboard(Dashboard):
    ...
    def get_absolute_url(self):
        return reverse(
            f"datorum.dashboards:dashboards:{self.get_slug()}",
