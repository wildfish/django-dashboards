...
from datorum.dashboards.exceptions import DashboardNotFoundError
from datorum.dashboards.utils import get_dashboard_class
...
class DashboardView(DashboardObjectMixin, TemplateView):
    ...
    template_name: str = "datorum/dashboards/dashboard.html"
...
class ComponentView(DashboardObjectMixin, TemplateView):
    ...
    template_name: str = "datorum/dashboards/components/partial.html"
